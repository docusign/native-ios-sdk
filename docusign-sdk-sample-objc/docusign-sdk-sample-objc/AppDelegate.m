...
{
    // determine if the device screen is allowed to rotate to landscape
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"docusign_sdk_sample_objc"];
