 ...
 * @see DSMTabFrame.h
 */
@property (nonatomic, strong) DSMTabFrame *frame;
/*!
 * @brief The DSMMergeField class object.
 * @see DSMMergeField.h
 */
@property (nonatomic, strong) DSMMergeField* mergeField;
/*!
 * @brief The DSMErrorDetails class object.
 * @see DSMErrorDetails.h
 */
@property (nonatomic, strong) DSMErrorDetails* errorDetails;
//@property (nonatomic, strong) DSMCDTabImageData *imageData;
