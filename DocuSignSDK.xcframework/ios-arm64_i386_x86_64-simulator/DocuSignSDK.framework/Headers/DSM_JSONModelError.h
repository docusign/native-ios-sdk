...
/////////////////////////////////////////////////////////////////////////////////////////////
typedef NS_ENUM(int, DSM_kJSONModelErrorTypes)
{
    DSM_kJSONModelErrorInvalidData = 1,
    DSM_kJSONModelErrorBadResponse = 2,
    DSM_kJSONModelErrorBadJSON = 3,
    DSM_kJSONModelErrorModelIsInvalid = 4,
    DSM_kJSONModelErrorNilInput = 5
};

/////////////////////////////////////////////////////////////////////////////////////////////
/** The domain name used for the JSONModelError instances */
extern NSString *const DSM_JSONModelErrorDomain;
 ...
 */
extern NSString *const DSM_kJSONModelMissingKeys;
 ...
 */
extern NSString *const DSM_kJSONModelTypeMismatch;
 ...
 */
extern NSString *const DSM_kJSONModelKeyPath;
 ...
 */
@interface DSM_JSONModelError : NSError
