 ...
 */
@property (nonatomic, strong) DSMEnvelopeTemplateDefinition *envelopeTemplateDefinition;
/*!
 ...
 * @see DSMDocument.h
 */
@property (nonatomic, strong) DSMDocument *combinedDocument;
/*!
 * @brief The DSMRecipients class object, list of recipients on template.
 * @see DSMRecipients.h
 */
@property (nonatomic, strong) DSMRecipients *recipients;
/*!
 * @brief The DSMRecipients class object, list of recipients on template.
 * @see DSMRecipients.h
 */
@property (nonatomic, strong) DSMNotification *notification;
@property (nonatomic, strong) DSMCustomFields *customFields;
@property (nonatomic, strong) DSMEmailSettings *emailSettings;
/*!
 ...
 */
@property (nonatomic, copy, nullable) NSString *envelopeId;
/*!
...
/*!
 * @brief The reason why envelope failed to Sync.
 */
@property (nonatomic,strong) NSString * syncFailureReason;
/*!
 * @brief The number of attempts failed to Sync.
 */
