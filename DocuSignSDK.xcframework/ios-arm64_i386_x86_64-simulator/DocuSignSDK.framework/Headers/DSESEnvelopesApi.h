...
/// @param isOfflineSigning True if using update recipients to sync remote envelope with offline signed content
///
...
-(NSNumber*) updateRecipientsWithCompletionBlock:(NSString*)accountId
                                ...
                                isOfflineSigning:(BOOL)isOfflineSigning
...
- (NSNumber *)setImageWithCompletionBlock:(NSString *)accountId
                            ...
                            userSignature:(DSESUserSignature *)userSignature
                                    image:(UIImage *)signatureImage
                                   ofType:(NSString *)imageType
                        completionHandler:(void (^)(DSESUserSignature *output, NSError *error))completionBlock;
...
- (NSNumber *)setImageWithCompletionBlock:(NSString *)accountId
                           ...
                           signatureImage:(UIImage *)signatureImage
                            initialsImage:(UIImage *)initialsImage
...
- (NSNumber *)updateSignatureFontWithCompletionBlock:(NSString *)accountId
                                              userId:(NSString *)userId
                                       userSignature:(DSESUserSignature *)userSignature
                                               image:(UIImage *)signatureImage
                                              ofType:(NSString *)imageType
...
- (NSNumber*)deleteSignatureWithCompletionBlock:(NSString*)accountId
                                         userId:(NSString*)userId
