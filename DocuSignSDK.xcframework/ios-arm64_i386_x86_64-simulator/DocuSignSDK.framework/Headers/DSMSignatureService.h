...
@class DSAPIUserSignaturesInformation;
 ...
 */
+ (void)getSignatureForRecipientWithId:(NSString *) recipientId
                         forEnvelopeId:(NSString *)envelopeId
...
+ (void)setSignatureImage:(UIImage *)signatureImage
            ofSignatureId:(NSString *)signatureId
                forUserId:(NSString *)userId
                     type:(NSString *)type
               completion:(nullable void (^)(DSMAdoptedSignature *_Nullable signaturesInformation, NSError *_Nullable error))completion;
/*!
 ...
 */
+ (void)createSignatureImage:(nullable UIImage *)signatureImage
