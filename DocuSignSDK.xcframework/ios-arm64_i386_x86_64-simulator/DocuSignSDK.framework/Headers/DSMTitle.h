...
/*!
 @class DSMTitle
 @abstract It describes a Title tab capabilities.
 @discussion Specifies a tag on the document where you want the recipient's title to appear.\n\nWhen getting information that includes this tab type, the original value of the tab when the associated envelope was sent is included in the response.
 @see DSMTextTabProtocol.h
 */
@interface DSMTitle : DSMTab  <DSMTextTabProtocol, DSMTextTabFontProtocol>
