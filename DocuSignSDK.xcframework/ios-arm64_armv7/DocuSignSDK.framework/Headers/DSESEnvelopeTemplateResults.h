...
@protocol DSESEnvelopeTemplateResults
@end

@interface DSESEnvelopeTemplateResults : DSESObject

/* The list of requested templates. [optional]
 */
@property(nonatomic) NSArray<DSESEnvelopeTemplateResult>* envelopeTemplates;
