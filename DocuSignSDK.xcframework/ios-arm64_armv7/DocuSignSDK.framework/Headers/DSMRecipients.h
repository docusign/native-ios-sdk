 ...
 * @see DSMSigner.h DSMInPersonSigner.h
 */
- (void)inPersonSignerFromSigner:(DSMSigner *)signer hostName:(NSString *)hostName hostEmail:(NSString *)hostEmail signerName:(NSString *)signerName signerEmail:(NSString * _Nullable)signerEmail;
