 ...
 */
@property(nonatomic, copy, nullable) NSNumber * routingOrder;
 ...
 */
@property (nonatomic, strong) DSMRecipientEmailNotification *emailNotification;
/*!
 * @brief TODO:Doc
 * @see DSMOfflineAttributes.h
 */
@property(nonatomic, strong) DSMOfflineAttributes *offlineAttributes;
/*!
 * @brief TODO:Doc
 * @see DSMSignature.h
 */
@property (nonatomic, strong) DSMSignature *signature;
