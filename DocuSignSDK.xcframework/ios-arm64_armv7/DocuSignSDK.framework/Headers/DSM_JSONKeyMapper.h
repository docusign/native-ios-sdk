...
typedef NSString *(^DSM_JSONModelKeyMapBlock)(NSString *keyName);
 ...
 * </pre>
 */
@interface DSM_JSONKeyMapper : NSObject

// deprecated
@property (readonly, nonatomic) DSM_JSONModelKeyMapBlock JSONToModelKeyBlock DEPRECATED_ATTRIBUTE;
...
- (instancetype)initWithJSONToModelBlock:(DSM_JSONModelKeyMapBlock)toModel modelToJSONBlock:(DSM_JSONModelKeyMapBlock)toJSON DEPRECATED_MSG_ATTRIBUTE("use initWithModelToJSONBlock:");
+ (instancetype)mapper:(DSM_JSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions DEPRECATED_MSG_ATTRIBUTE("use baseMapper:withModelToJSONExceptions:");
...
@property (readonly, nonatomic) DSM_JSONModelKeyMapBlock modelToJSONKeyBlock;
 ...
 */
- (instancetype)initWithModelToJSONBlock:(DSM_JSONModelKeyMapBlock)toJSON;
 ...
 * Use your JSONModel property names as keys, and the JSON key names as values.
 */
+ (instancetype)baseMapper:(DSM_JSONKeyMapper *)baseKeyMapper withModelToJSONExceptions:(NSDictionary *)toJSON;
